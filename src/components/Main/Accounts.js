    ...
    if (!accounts.length) {
      ...
      <>
        <AccountCard 
          ...
          bal={acct.balance}
          isClicked={isSavings(acct.accountType) ? isSavingsBalClicked : isPayBalClicked}
          setIsClicked={isSavings(acct.accountType) ? setIsSavingsBalClicked : setIsPayBalClicked}
        />
        <AddAccountCard type={isSavings(acct.accountType) ? 'PAY' : 'SAVINGS'} />
      </>)
